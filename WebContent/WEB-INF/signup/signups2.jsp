    ...
    <div id="wrapper"> 
			...
			<div id="header"> 
				...
				<div class="navigation">
					<ul>
						<li><a href="/LinkedForever/signup.do?flag=returnWelcome">Home</a></li>
			...
			<div id="page_content"> 
				...
				<div class="right_section">
					...
					<h3>Sign Up Step Two</h3>
					
					<c:if test="${errInfo}">
       					<small id="emailHelp" class="form-text text-muted">Attention : The name is obligatory !</small>
       				</c:if> 
					
					<form action="/LinkedForever/signup.do?flag=signups2" method="post">
 					 	...
 					 	<div class="form-group">
    						...
    						<input name="sex" class="form-control" id="exampleInputPassword1" placeholder="Sex">
  						</div>
  						<div class="form-group">
    						<label for="exampleInputPassword1">Birthday</label>
    						<input name="birthday" class="form-control" id="exampleInputPassword1" placeholder="Birthday">
    						<small id="emailHelp" class="form-text text-muted">day/month/year.</small>
  						</div>
