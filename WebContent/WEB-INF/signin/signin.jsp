		...
		<div id="wrapper"> 
			...
			<div id="page_content"> 
				...
				<div class="right_section">
					...
					<h3>Sign In</h3>
					<c:if test="${errInfo}">
       					<small id="emailHelp" class="form-text text-muted">Attention : Your Email address or Password is not correct !</small>
       				</c:if> 
					<form action="/LinkedForever/login.do?flag=login" method="post">
