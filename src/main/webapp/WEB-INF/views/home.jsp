  ...
  <div id="page_content"> 
    ...
    <div class="left_side_bar"> 
      ...
      <div class="col_1">
       <div class="box">
          <ul>
            <li><button><a href="<c:url value="/spittles" />">What's going on</a></button></li>
            <li><button><a href="<c:url value="/spitter/register" />">Subscription</a></button></li>
          </ul>
        </div>
      </div>
...
rutrum. Aenean imperdiet.</p>
      ...
      <div class="top_content">
        <div class="column_one">
          <h2>Subscription</h2>
          <p>You need to subscribe to our social network in order to consult people's profiles or establishment's groups. </p>
          <br>
          <p><a href="<c:url value="/spitter/register" />" class="btn">Sign up !</a></p></div>
        <div class="column_two border_left">
          <h2>Want to learn more about us?</h2>
          <p>If you are interested in our project, feel free to read our "About" section in the navigation bar.
		  If you have any question, you can contact us or read the Q&A's <u>here</u></p>
          <br>
      </div>
    </div>
